...
export const jobDetail = {
  ...
  invoices: {
    title: 'Facturas',
    empty: 'Este encargo no tiene facturas.',
    issue: 'Emitir factura',
    issueHint: 'Se emite con el importe del presupuesto aceptado o, si no lo hay, con el del encargo.',
    number: 'Número',
    status: 'Estado',
    total: 'Total',
    pending: 'Pendiente',
    ...
    paidLabel: 'Cobrado',
    owedLabel: 'Queda',
    paymentTitle: 'Registrar cobro',
    amount: 'Importe en euros',
    method: 'Cómo',
    reference: 'Referencia (opcional)',
    register: 'Registrar cobro',
    watermarkOn: 'Las fotos de la galería salen con marca de agua hasta que se cobre.',
    watermarkOff: 'La galería no lleva marca de agua.',
    statuses: {
      draft: 'Borrador',
      issued: 'Emitida',
      paid: 'Pagada',
