...
export const jobDetail = {
  ...
  money: {
    ...
    perHourHint: 'El neto entre las horas que has metido en este encargo.',
    needHours: 'Anota horas para ver el euros por hora.',
    invoiceLater: 'La factura llega cuando se conecte el proveedor de facturación.',
    expensesTitle: 'Gastos del encargo',
    expensesEmpty: 'Todavía no hay gastos anotados.',
    expenseAmount: 'Importe en euros',
    expenseDescription: 'Concepto',
    expenseDate: 'Día',
    expenseCategory: 'Tipo',
    expenseAdd: 'Anotar gasto',
    expenseCats: {
      travel: 'Viaje',
      gear: 'Equipo',
      software: 'Software',
  ...
  quotes: {
    title: 'Presupuestos',
    empty: 'Este encargo no tiene presupuestos.',
    newTitle: 'Nuevo presupuesto',
    lineDescription: 'Concepto',
    lineQty: 'Cantidad',
    lineUnit: 'Precio unidad (€)',
    lineTax: 'IVA (%)',
    ...
    needLine: 'Añade al menos una línea con concepto e importe.',
    colNumber: 'Número',
    colStatus: 'Estado',
    colTotal: 'Total',
  ...
  gallery: {
    ...
    linkLabel: 'Enlace para el cliente',
    copyLink: 'Copiar enlace',
    copied: 'Copiado',
    pinFresh: 'Este es el PIN. Apúntalo y envíaselo al cliente: no vuelve a mostrarse.',
    pinLabel: 'PIN',
    expiresLabel: 'Caduca el',
    expiredNote: 'Ya ha caducado.',
    watermarkOn: 'Con marca de agua',
    watermarkOff: 'Sin marca de agua',
    statusRevoked: 'Revocada. El enlace ya no abre nada.',
    regenerate: 'Generar PIN nuevo',
    revoke: 'Revocar acceso',
    revokeConfirm: '¿Seguro? El cliente pierde el acceso al instante.',
    favoritesTitle: 'Selección recibida',
    favoritesEmpty: 'El cliente aún no ha enviado su selección.',
    favoritesNote: 'Nota del cliente',
    error: 'No se ha podido completar. Vuelve a intentarlo.',
  },
} as const
